        ...
        if isinstance(msg, bs.PickedUpMessage):
            ...
            if (msg.powerupType == 'tripleBombs'):
                ...
                try:
                    ...
                    print "Error en powerupType 'Troll':", e
            ...
            elif msg.powerupType == 'dbomb':
                bsUtils.PopupText(u"\ue00c Dbomb \ue00c",color = self.node.color,scale = 1.7, position = self.node.position).autoRetain()
                tex = bs.Powerup.getFactory().texBomb
                self._flashBillboard(tex)
                self.setBombCount(0)
